...
function Ocor2() {
  ...
  return (
    ...
    >{data.filter(ocorrencia => ocorrencia.aprovacao === 'Aprovado' && ocorrencia.status === 'Em avaliação' && ocorrencia.prioridade === 'grau2').map((ocorrencia, index) => (
      <Box
        key={index}
        sx={{
          width: '1000px',
